...
#show: book.with(
  title: [Pengambilan Keputusan Dengan Probabilitas dan Statiastika],
...
[#NormalTok("plt.show()");],));
#block[
#Skylighting(([#NormalTok("rata-rata selang tiba:  11.47402609668567");],
[#NormalTok("rata-rata selang layanan:  6.224575980320161");],
[#NormalTok("rata-rata antrian:  5.212786790972691");],
[#NormalTok("rata-rata total layanan:  11.437362771292849");],));
]
#box(image("intro_files/figure-typst/cell-2-output-2.svg"))
