...
1.  1\. **Modeling (30 poin):** Representasikan sistem berikut dalam fungsi Python:

    1.  \- Sub-sistem A: 3 Web Server (Paralel, @R=0.9).

    2.  \- Sub-sistem B: 1 Database Utama (R=0.99).

    3.  \- Sistem Total: Sub-sistem A terhubung Seri dengan Sub-sistem B.

2.  2\. **Calculation (30 poin):** Hitung reliabilitas teoretis sistem total.

3.  3\. **Simulation (20 poin):** Jalankan simulasi 10.000 kali.

    1.  \- Generate status acak untuk tiap komponen.

    2.  \- Cek logika: `(Web1 OR Web2 OR Web3) AND Database`.

    3.  \- Hitung frekuensi sukses empiris.

4.  4\. **Analysis (20 poin):** Jika budget memungkinkan penambahan 1 komponen (Web Server lagi ATAU Database Backup), mana yang paling signifikan menaikkan reliabilitas total? Buktikan dengan angka.
