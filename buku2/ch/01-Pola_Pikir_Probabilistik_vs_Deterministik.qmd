...
Bila jawaban keduanya ya, maka besaran ini determnistik. Acak tidak memiliki formula untuk menghasilkan besaran, meskipun prediksi bisa dilakukan dengan akurasi ditentukan sebuah besaran probabilitas $p$.

**Simulasi Python**
Sebuah simulasi berikut adalah contoh perbandingan antara proses deterministik dan acak.
...
```
Maka simulasi dilakukan dengan memanfaatkan fungsi np.random.normal di atas.
